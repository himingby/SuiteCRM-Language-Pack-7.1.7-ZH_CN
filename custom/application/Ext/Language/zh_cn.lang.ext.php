...
$app_list_strings["moduleList"]["SecurityGroups"] = '安全组管理';
$app_strings['LBL_LOGIN_AS'] = "登录 ";
$app_strings['LBL_LOGOUT_AS'] = "退出 ";
$app_strings['LBL_SECURITYGROUP'] = '安全组';
...
$app_list_strings['call_reschedule_dom']['Out of Office'] = '不在公司';
$app_list_strings['call_reschedule_dom']['In a Meeting'] = '开会中';

$app_strings['LBL_RESCHEDULE_LABEL'] = '重新计划';
$app_strings['LBL_RESCHEDULE_TITLE'] = '请输入更改信息';
$app_strings['LBL_RESCHEDULE_DATE'] = '日期:';
$app_strings['LBL_RESCHEDULE_REASON'] = '理由:';
$app_strings['LBL_RESCHEDULE_ERROR1'] = '请选择一个有效日期';
$app_strings['LBL_RESCHEDULE_ERROR2'] = '请选择一个理由';

$app_strings['LBL_RESCHEDULE_PANEL'] = '重新计划';
$app_strings['LBL_RESCHEDULE_HISTORY'] = '尝试呼叫历史记录';
$app_strings['LBL_RESCHEDULE_COUNT'] = '尝试呼叫次数';
...
$app_list_strings['fp_event_invite_status_dom']['Attended'] = '参加';
$app_list_strings['fp_event_invite_status_dom']['Not Attended'] = '不参加';
...
$app_strings['LBL_LISTVIEW_OPTION_CURRENT'] = '选择本页';
$app_strings['LBL_LISTVIEW_OPTION_ENTIRE'] = '全选';
$app_strings['LBL_LISTVIEW_NONE'] = '全不选';
...
$app_list_strings['moduleList']['AOP_AOP_Case_Events'] = '客户反馈事件';
...
$app_strings['LBL_AOP_EMAIL_REPLY_DELIMITER'] = '========== 请在划线上方回复 ==========';
...
$app_list_strings['case_state_default_key'] = '未结';
$app_list_strings['case_status_default_key'] = '未结_新增';
...
$app_strings['LBL_QUICK_ACCOUNT'] = '新建客户';
$app_strings['LBL_QUICK_CONTACT'] = '新建联系人';
$app_strings['LBL_QUICK_OPPORTUNITY'] = '新建商业机会';
$app_strings['LBL_QUICK_LEAD'] = '新建潜在客户';
$app_strings['LBL_QUICK_DOCUMENT'] = '新建文档';
$app_strings['LBL_QUICK_CALL'] = '安排电话';
$app_strings['LBL_QUICK_TASK'] = '新建任务';
$app_strings['LBL_COLLECTION_TYPE'] = '类型';

$app_strings['LBL_ADD_TAB'] = '添加标签';
$app_strings['LBL_SUITE_DASHBOARD'] = 'Suite仪表盘';
$app_strings['LBL_ENTER_DASHBOARD_NAME'] = '输入仪表盘名称:';
$app_strings['LBL_NUMBER_OF_COLUMNS'] = '列数:';
$app_strings['LBL_DELETE_DASHBOARD1'] = '您确定要删除此';
$app_strings['LBL_DELETE_DASHBOARD2'] = '仪表盘?';
$app_strings['LBL_ADD_DASHBOARD_PAGE'] = '增加仪表盘页';
$app_strings['LBL_DELETE_DASHBOARD_PAGE'] = '移除当前仪表盘页';
$app_strings['LBL_RENAME_DASHBOARD_PAGE'] = '重命名仪表盘页';

$app_strings['LBL_DISCOVER_SUITECRM'] = '发现SuiteCRM';
...
$app_list_strings['moduleList']['AOS_Products_Quotes'] = '项目行';
$app_list_strings['moduleList']['AOS_Line_Item_Groups'] = '项目行组';
...
$app_list_strings['quote_stage_dom']['Delivered'] = '已提交';
...
$app_list_strings['quote_stage_dom']['Closed Lost'] = '丢单结束';
...
$app_list_strings['approval_status_dom']['Approved'] = '已批准';
$app_list_strings['approval_status_dom']['Not Approved'] = '未批准';
...
$app_list_strings['product_category_dom']['Laptops'] = '笔记本电脑';
$app_list_strings['product_category_dom']['Desktops'] = '台式机';
$app_list_strings['product_category_dom'][''] = '';
$app_list_strings['product_type_dom']['Good'] = '产品';
...
$app_strings['LBL_NO_TEMPLATE'] = '出错\n没找到模板。\n请到PDF模板模块去创建一个模板。';
...
$app_strings['LBL_JJWG_MAPS_GEOCODE_STATUS'] = 'Geocode状态';
$app_strings['LBL_JJWG_MAPS_ADDRESS'] = '地址';
$app_strings['LBL_BUG_FIX'] = '故障修复';
...
$app_list_strings['aow_email_to_list']['to'] = '发送给';
$app_list_strings['aow_email_to_list']['cc'] = '抄送给';
$app_list_strings['aow_email_to_list']['bcc'] = '密送给';
$app_list_strings['aow_run_on_list']['All_Records'] = '所有记录';
$app_list_strings['aow_run_on_list']['New_Records'] = '新记录';
$app_list_strings['aow_run_on_list']['Modified_Records'] = '修订的记录';
