...
//WIZARDS
//STUDIO WIZARD
'LBL_SW_WELCOME'=>'<h2>欢迎使用工作室！</h2><br> 今天想做些什么呢?<br><b> 请从下面的选项中选择。</b>',
...
'LBL_SMW_WELCOME'=>'<h2>欢迎使用工作室！</h2><br><b>请选择下面的一个模块。',
...
'LBL_MB_DELETE'=>'删除',
'LBL_MB_COMPARE'=>'比较',
'LBL_MB_WELCOME'=> '<h2>历史记录</h2><br> 在历史记录中，您可以查看以前公布的文件修改。您可以比较和恢复以前的版本。如果您恢复了文件，它就会成为您的工作文件。在它被其他人看到以前，您必须公布它。<br> 您今天想做些什么呢?<br><b> 请从下面的选项中选择。</b>',

//EDIT DROP DOWNS
'LBL_ED_CREATE_DROPDOWN'=> '新增下拉框',
'LBL_ED_WELCOME'=>'<h2>编辑下拉框</h2><br><b>您既可以编辑一个存在的下拉框，也可以新增一个下拉框。',
'LBL_DROPDOWN_NAME' => '下拉列表名称:',
'LBL_DROPDOWN_LANGUAGE' => '下拉列表语言:',
'LBL_TABGROUP_LANGUAGE' => '语言:',

//EDIT CUSTOM FIELDS
'LBL_EC_WELCOME'=>'<h2>自定义字段编辑器</h2><br><b>您可以编辑视图，或者已存在的自定义字段。新增自定义字段，或者清除自定义字段缓存。',
'LBL_EC_VIEW_CUSTOMFIELDS'=> '查看自定义字段',
'LBL_EC_CREATE_CUSTOMFIELD'=>'新增自定义字段',
'LBL_EC_CLEAR_CACHE'=>'清除缓存',

//SELECT MODULE
'LBL_SM_WELCOME'=> '<h2>历史记录</h2><br><b>请选择您要查看的文件。</b>',
//END WIZARDS
...
'LBL_LISTVIEWP_DESCRIPTION'=>'默认列包含要显示的字段，有效列包含那些没有显示，但是是可以被显示的字段。在两列之间拖拽字段。您也可以通过拖拽，重新排列列中的记录。',
'LBL_SP_STYLESHEET'=>'上传样式',
'LBL_SP_UPLOADSTYLE'=>'点击“浏览”按钮，并选择一个上传的样式。<br> 下一次您同步门户网站，他会被同步到门户网站中。',
'LBL_SP_UPLOADED'=> '已上传',
