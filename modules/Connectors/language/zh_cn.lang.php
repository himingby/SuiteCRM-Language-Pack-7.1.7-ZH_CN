...
$mod_strings = array (
    ...
    'LBL_ENABLED' => '启用',
    'LBL_EXTERNAL' => '让用户创建外部账户记录这个连接器。',
    'LBL_EXTERNAL_SET_PROPERTIES' => ' 为了使用这个连接器,属性也应设置在页面设置连接器属性设置。',
    ...
    'ERROR_NO_SEARCHDEFS_MAPPED' => '错误:没有连接器启用搜索字段定义。',
    ...
    'LBL_TWITTER_USER' => 'Twitter用户',
    'LBL_FACEBOOK_USER' => 'Facebook用户',
);
