...
$mod_strings = array (
	...
	'LBL_CONFIRM_DELETE'		=> '你确定要删除这个文件夹吗?',
	'LBL_ENTER_FOLDER_NAME'		=> '请输入文件夹名字',
	...
	'LBL_ADD_ANOTHER_FILE'		=> '增加另一个文件',
    'LBL_ADD_DASHLETS'          => '增加SuiteCRM Dashlets',
	...
	'LBL_EMAIL_EDITOR_OPTION'	=> '发送HTML邮件',
    ...
    'LBL_EMPTY_FOLDER'          => '没有可显示邮件',
	'LBL_ERROR_SENDING_EMAIL'	=> '邮件发送错误',
	'LBL_ERROR_SAVING_DRAFT'	=> '草稿保存错误',
    ...
    'LBL_WARN_NO_USERS_OR_TEAM' => '请选择一个用户或团队任务.',
    ...
    'LBL_EMAILTEMPLATE_MESSAGE_CLEAR_MSG' => '选择”——没有——”将清晰的电子邮件中的任何数据已经进入身体。你希望继续吗?',
	'LBL_EMAILTEMPLATE_MESSAGE_WARNING_TITLE' => '警告',
	'LBL_EMAILTEMPLATE_MESSAGE_MULTIPLE_RECIPIENTS' => '使用电子邮件模板包含联系的变量,比如联系人的名字,寄电子邮件给多个接收者可能意想不到的结果。建议您使用电子邮件群发邮件。',
	'LBL_CHECK_ATTACHMENTS'=>'请检查附件!',
	'LBL_HAS_ATTACHMENTS' => '这封邮件已附件(年代)。你想保持附件(s)?',
	'ERR_MISSING_REQUIRED_FIELDS' => '缺少必需字段',
    'ERR_INVALID_REQUIRED_FIELDS' => '无效的必需字段',
	'LBL_FILTER_BY_RELATED_BEAN' => '只显示相关的接受者',
    'LBL_RECIPIENTS_HAVE_BEEN_ADDED' => '添加了收件人。',
    'LBL_ADD_INBOUND_ACCOUNT' => '增加',
    'LBL_ADD_OUTBOUND_ACCOUNT' => '增加',
    'LBL_EMAIL_ACCOUNTS_INBOUND' => '邮件帐户属性',
    'LBL_EMAIL_SETTINGS_OUTBOUND_ACCOUNT' => '即将离任的SMTP邮件服务器',
    'LBL_EMAIL_SETTINGS_OUTBOUND_ACCOUNTS' => '即将离任的SMTP邮件服务器',
    'LBL_EMAIL_SETTINGS_INBOUND_ACCOUNTS' => '邮件账户',
    'LBL_EMAIL_SETTINGS_INBOUND' => '收件箱',
    'LBL_EMAIL_SETTINGS_OUTBOUND' => '发件箱',
	'LBL_ADD_CC' => '添加抄送（Cc）',
	'LBL_ADD_BCC' => '添加隐蔽抄送(Bcc)',
    'LBL_MOVE_TO_BCC' => '移动到Bcc',
	...
	'LBL_CREATE_CASES' => '创建用例' /*for 508 compliance fix*/,
	'LBL_CREATE_LEADS' => '创建销售线索' /*for 508 compliance fix*/,
	...
	'LBL_CHECKEMAIL' => '检查Email' /*for 508 compliance fix*/,
	'LBL_COMPOSEEMAIL' => '撰写Email' /*for 508 compliance fix*/,
	'LBL_EMAILSETTINGS' => 'Email设置' /*for 508 compliance fix*/,
