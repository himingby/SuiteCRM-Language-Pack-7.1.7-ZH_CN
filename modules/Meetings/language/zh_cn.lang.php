...
$mod_strings = array (
    ...
    'LBL_REMINDER_EMAIL_ALL_INVITEES' => '给受邀者发邮件',
    'LBL_EMAIL_REMINDER' => '电子邮件提醒',
  ...
  //For export labels
    'LBL_EXPORT_JOIN_URL' => '加入链接',
    'LBL_EXPORT_HOST_URL' => '主机链接',
    'LBL_EXPORT_DISPLAYED_URL' => '显示链接',
    'LBL_EXPORT_ASSIGNED_USER_ID' => '负责人编号',
    'LBL_EXPORT_EXTERNAL_ID' => '外部编号',
    ...
    'LBL_EXPORT_PARENT_TYPE' => '关联类型',
    'LBL_EXPORT_PARENT_ID' => '父记录编号',
    ...
    'LBL_EMPTY_SEARCH_RESULT' => '对不起，没找到记录。请在下方创建一个被邀请人。',
    ...
    'LBL_REPEAT_PARENT_ID' => '重复父记录编号',
    'LBL_RECURRING_SOURCE' => '周期重复源',
    
    'LBL_SYNCED_RECURRING_MSG' => '第三方系统中的会议信息已经同步到SuiteCRM中。如果需要修改会议信息，请到第三方软件中修改，修改后，信息会自动同步过来。',
    'LBL_RELATED_TO' => '相关:',
);
?>
