...
/*	'DISABLE_EXPORT'=>'Disable export',*/
	...
	'LBL_YAHOOMAIL_SMTPPASS'					=> 'Yahoo!邮箱密码:',
	'LBL_YAHOOMAIL_SMTPUSER'					=> 'Yahoo!邮箱ID:',
	'LBL_GMAIL_SMTPPASS'					=> 'Gmail密码:',
	'LBL_GMAIL_SMTPUSER'					=> 'Gmail Email地址:',
    ...
    'LBL_ALLOW_DEFAULT_SELECTION'           => '允许用户使用这对即将离任的电子邮件帐户:',
	...
	'LBL_MAILMERGE' => '邮件合并',
	'LBL_MIN_AUTO_REFRESH_INTERVAL' => '最小新增栏自动刷新间隔',
	...
	'LBL_PORTAL_ON' => '允许企业用户管理',
	'LBL_PORTAL_TITLE' => '客户自助服务门户',
	'LBL_PROXY_AUTH'=>'身份验证?',
	'LBL_PROXY_HOST'=>'代理主机',
	'LBL_PROXY_ON_DESC'=>'配置代理服务器地址和身份验证设置',
	'LBL_PROXY_ON'=>'使用代理服务器?',
	'LBL_PROXY_PASSWORD'=>'密码',
	'LBL_PROXY_PORT'=>'端口',
	'LBL_PROXY_TITLE'=>'代理设置',
	'LBL_PROXY_USERNAME'=>'用户名称',
	'LBL_RESTORE_BUTTON_LABEL'=>'恢复',
	'LBL_SYSTEM_SETTINGS' => '系统设置',
	'LBL_SKYPEOUT_ON_DESC' => '使用SkypeOut&reg;用户就可以直接点击电话号码拨打电话。电话号码必须使用一定的格式。也就是说，电话号码格式为“+”号+"国家代码"+"电话号码"，比如 +1 (555) 555-1234。',
	'LBL_SKYPEOUT_ON' => '启用SkypeOut&reg;继承功能',
    ...
    'LIST_ENTRIES_PER_LISTVIEW'=>'列表视图项每个页面',
	'LIST_ENTRIES_PER_SUBPANEL'=>'子面板项目每个页面',
	'LOG_MEMORY_USAGE'=>'日志内存使用',
	'LOG_SLOW_QUERIES'=>'日志查询缓慢',
    ...
    'CURRENT_LOGO'=>'当前的logo:',
    'CURRENT_LOGO_HELP'=>'此logo显示在Sugar应用程序的左下角。',
    'NEW_LOGO'=>'选择log:',
    'NEW_LOGO_HELP'=>'图象文件一定是 .png或 .jpg格式。<BR>推荐尺寸为 212x40像素。',
    'NEW_LOGO_HELP_NO_SPACE'=>'用作logo的图片文件格式是.png或者.jpg。高度最大为17像素，宽度最大为450像素。图片文件名称不能包含空格。 如果上传的文件无论在高度或宽度超过此尺寸，都会被缩成此尺寸。',
	...
	'LBL_LOGGER_MAX_LOG_SIZE'=>'日志最大上限',
	'LBL_LOGGER_DEFAULT_DATE_FORMAT'=>'默认日期格式',
	'LBL_LOGGER_LOG_LEVEL'=>'日志级别',
    'LBL_LEAD_CONV_OPTION' => '潜在客户转化选项',
    'LEAD_CONV_OPT_HELP' => '<b>复制</b> - 创建并关联所有潜在客户的活动记录到转化过程中新创建的记录上。<br><br><b>移动</b> - 移动潜在客户的所有活动记录，关联到转化过程中新创建的记录上。<br><br><b>什么都不做</b> - 转化过程中不修改人和潜在客户的活动记录，活动记录仍旧只和潜在客户关联。',
    'LBL_CONFIG_AJAX' => '配置AJAX用户界面',
    'LBL_CONFIG_AJAX_DESC' => '针对每个模块禁用或启用AJAX用户界面。',
	'LBL_LOGGER_MAX_LOGS' => '最大日志数(在滚动记录前)',
	'LBL_LOGGER_FILENAME_SUFFIX' => '在文件明后追加',
	'LBL_VCAL_PERIOD' => '日历闲忙信息更新时间范围:',
    'LBL_IMPORT_MAX_RECORDS' => '导入 - 最大行数:',
    'LBL_IMPORT_MAX_RECORDS_HELP' => '设定在导入文件时的最大处理行数。如果导入时超过该行数，将提醒用户。不输入任何数字，将不做限制。',
...
// Wizard
    ...
    'LBL_WIZARD_WELCOME' => '单击 <b>下一步</b> 修改SugarCRM的商标、时区等相关设置。如果你希望以后再配置这些选项，请单击 <b>跳过</b>.',
...
To configure additional system settings, click <a href="index.php?module=Administration&action=index" target="_blank">here</a>.',
	...
	'LBL_GMAIL_LOGO' => 'Gmail标志' /*for 508 compliance fix*/,
