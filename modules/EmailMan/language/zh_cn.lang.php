...
$mod_strings = array (
	...
	'LBL_CHOOSE_EMAIL_PROVIDER'        => '外发电子邮件配置',
	'LBL_YAHOOMAIL_SMTPPASS'					=> '雅虎邮箱密码',
	'LBL_YAHOOMAIL_SMTPUSER'					=> '雅虎邮箱ID',
    ...
    'LBL_EMAIL_LINK_TYPE_HELP'			=> '< b >sugar件客户端:< / b >发送电子邮件使用糖的电子邮件客户端应用程序。< br > < b >外部邮件客户端:< / b >发送电子邮件使用一个糖以外的电子邮件客户端应用程序,比如Microsoft Outlook。',
