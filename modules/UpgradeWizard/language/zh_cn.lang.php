...
$mod_strings = array(
	...
	'LBL_UPLOAD_FILE_NOT_FOUND'					=> '上传文件未找到',
	'LBL_UW_BACKUP_FILES_EXIST_TITLE'			=> '文件备份',
	'LBL_UW_BACKUP_FILES_EXIST'					=> '从这可以找到升级备份文件',
	'LBL_UW_BACKUP'								=> '文件备份',
	'LBL_UW_CANCEL_DESC' => '取消升级向导。所有临时文件和上传的zip文件被删除。<br><br>点击“下一步”重新开始升级向导。',
	'LBL_UW_CHARSET_SCHEMA_CHANGE'				=> '字符集模式变化',
	...
	'LBL_UW_COPIED_FILES_TITLE'					=> '文件复制成功',
	...
	'LBL_UW_START_DESC3'						=> '单击Next以执行一个检查你的系统,以确保系统升级的准备。检查包括文件权限,数据库特权和服务器设置。.',
	...
	'LBL_UW_SUGAR_COMMUNITY_EDITION_LICENSE'    => 'Sugar 社区版5.0遵循GNU General Public License Version 3. 升级后将转换成如下许可证.',
    ...
    'LBL_PREFLIGHT_FILE_COPYING_PROGRESS'       => '文件复制在过程中',
	'LBL_COMMIT_UPGRADE_IN_PROGRESS'            => '升级在过程中',
    'LBL_UW_COMMIT_DESC'						=> '单击Next以运行额外的升级脚本.',
	'LBL_UPGRADE_SCRIPTS_IN_PROGRESS'			=> '升级脚本在过程中',
	'LBL_UPGRADE_SUMMARY_IN_PROGRESS'			=> '升级总和在过程中',
	'LBL_UPGRADE_IN_PROGRESS'                   => '在过程中     ',
	'LBL_UPGRADE_TIME_ELAPSED'                  => '时间',
	'LBL_UPGRADE_CANCEL_IN_PROGRESS'			=> '升级取消和清除在过程中',
    'LBL_UPGRADE_TAKES_TIME_HAVE_PATIENCE'      => '升级会花费一点时间',
	...
	'LBL_HOME_PAGE_4_NAME' => '访问记录',
	'LBL_CURRENT_PHP_VERSION' => '(您当前的PHP版本是 ',
	'LBL_RECOMMENDED_PHP_VERSION' => '. 推荐使用PHP5.2.2或以上版本)',
	'LBL_MODULE_NAME' => '升级向导',
	'LBL_UPLOAD_SUCCESS' => '升级包成功上传。单击“下一步”进行最后的检查。',
	'LBL_UW_TITLE_LAYOUTS' => '确认布局',
	'LBL_LAYOUT_MODULE_TITLE' => '布局',
	'LBL_LAYOUT_MERGE_DESC' => '本次升级会产生一些新的字段，并会自动添加到现有模块布局中。要获取更多关于新字段的信息，请参考您要升级的版本的版本注释。<br><br>如果您不想增加这些字段，请取消选中的模块，这样您的自定义布局将会保持不变。升级后这些新字段会出现在工作室里。 <br><br>',
	'LBL_LAYOUT_MERGE_TITLE' => '单击“下一步”来确认并完成此次升级。',
	'LBL_LAYOUT_MERGE_TITLE2' => '单击“下一步”完成升级。',
    ...
    'ERROR_VERSION_INCOMPATIBLE' => '上传的文件与当前的SuiteCRM版本不兼容: ',
    'ERROR_FLAVOR_INCOMPATIBLE'  => '上传的文件与该SuiteCRM版本（社区版、专业版或企业版）不兼容: ',
