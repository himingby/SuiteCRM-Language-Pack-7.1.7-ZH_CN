...
$mod_strings = array (
	'LBL_CAPTCHA_HELP_TEXT'=>'Captcha是全自动区分计算机和人类的图灵测试。 请从 reCAPTCHA (http://recaptcha.net/) 获取一个公有密匙与私有密匙。',
	'CAPTCHA'=>'Captcha验证',
	'CAPTCHA_PRIVATE_KEY'=>'Captcha私有密匙',
	'CAPTCHA_PUBLIC_KEY'=>'Captcha公有密匙',
	'ENABLE_CAPTCHA'=>'启用reCAPTCHA验证',
	'ERR_PUBLIC_CAPTCHA_KEY'=> '无效Captcha密匙',
	'BTN_REBUILD_CONFIG' =>'重建',
	'EXPORT_DELIMITER' => '导出分隔符',
	'ADMIN_EXPORT_ONLY'=>'仅供管理员导出',
	'EXPORT'=>'导出设置',
	'EXPORT_CHARSET' => '缺省导入/导出字符集',
	'DISABLE_EXPORT'=>'禁用导出',
    ...
    'DL_PACKAGES_OF' => 'of',
    'DL_PACKAGES_PACKAGES' => '程序包',
    'LOADING_CATEGORIES' => '正在加载类别...',
    'SEARCHING_PACKAGES' => '正在查找程序包...',
    'AUTHENTICATING' => '验证中...',
    ...
    'ERR_INVALID_LOCALE_NAME_FORMAT_UPGRADE' =>'升级前设置的"名称格式"现在已经不再支持。名称格式已被设置成缺省格式。请选择一个新的格式，保存后，该信息将消失。',

    'ERR_CANNOT_CREATE_RESTORE_FILE' => '错误:不能创建恢复文件',
    'ERR_CREDENTIALS_MISSING'   => '您缺少sugarcrm.com信任书.',
    ...
    'ERR_NOT_IMPLEMENTED'=>'此功能目前尚未实现此配置。',
    ...
    'ERR_UW_MUST_SELECT_OVERWRITE_OPTION' => '请选择覆盖选项',
    'ERR_UW_NO_DEPENDENCY'      => "下列依存项目没有被系统发现",
    'ERR_UW_NO_FILES'                           => "没有指明要复制的文件.",
    'ERR_UW_NO_INSTALL_FILE'                    => "没有指明要安装的文件.",
    'ERR_UW_NO_LANG_DESC'                       => "没有指明语言包描述.",
    'ERR_UW_NO_LANG'                            => "没有指明语言包名称.",
    'ERR_UW_NO_MANIFEST'                        => "zip文件中找不到manifest.php文件. 无法继续.",
    'ERR_UW_NO_MODE'                            => "没有指定操作模式.",
    'ERR_UW_NO_TEMP_DIR'                        => "没有设定要复制的文件所在的临时文件夹.",
    'ERR_UW_NO_UPDATE_RECORD'                   => '找不到安装记录',
    'ERR_UW_NO_UPLOAD_FILE'                     => "请点击浏览从您的系统中选择文件上传.<br>\n",
    ...
    'ERR_UW_REMOVE_FAILED'                      => '不能删除文件',
    'ERR_UW_REMOVE_PACKAGE'                     => "移除程序包时有问题",
    'ERR_UW_RUN_SQL'                            => "执行sql文件时发生错误: ",
    'ERR_UW_UPDATE_CONFIG'                      => "使用新版本信息更新文件config.php时发生错误.",
    'ERR_UW_UPLOAD_ERROR'                       => "上传文件时出错，请重试!<br>\n",
    'ERROR_FLAVOR_INCOMPATIBLE' => '上传的文件和SuiteCRM的版本(开源版，专业版，企业版)不兼容: ',
    'ERROR_LICENSE_EXPIRED'=> "错误：您的许可过期 ",
    'ERROR_LICENSE_EXPIRED2' => " 天.  请到 <a href='index.php?action=LicenseSettings&module=Administration'>'\"许可证管理\"</a>  在管理员界面输入您的新的license. 如果您在您的license到期7天内不输入新的license，您将不能再登录上本系统。",
    'ERROR_MANIFEST_TYPE' => 'Manifest文件里必须指定程序包类型[Type].',
    'ERROR_PACKAGE_TYPE' => 'Manifest文件找到了一个不能识别的程序包类型',
    'ERROR_VALIDATION_EXPIRED'=> "错误：您验证的关键字过期 ",
    'ERROR_VALIDATION_EXPIRED2' => " 天. 请到<a href='index.php?action=LicenseSettings&module=Administration'>'\"许可证管理\"</a>在管理员界面输入您新的验证关键字.  如果您不在7天关键字验证有效期内输入新验证关键字, 您将不能再登录上本系统.",
    'ERROR_VERSION_INCOMPATIBLE' => '您上传的文件和当前版本的SuiteCRM不兼容: ',

    'FATAL_LICENSE_ALTERED' => "您的许可证已经改变。 <br> 请到 <a href='index.php?action=LicenseSettings&module=Administration'>'\"许可证管理\"</a>  在管理员界面.",
    'FATAL_LICENSE_EXPIRED'=> "严重: 您的许可证7天前已到期",
    'FATAL_LICENSE_EXPIRED2'=> "请到 <a href='index.php?action=LicenseSettings&module=Administration'>'\"许可证管理\"</a>  在管理员界面更新您的许可证信息，并恢复全部功能.",
    'FATAL_LICENSE_REQUIRED' => "严重: 您需要更新您的许可证信息.<br>  请到 <a href='index.php?action=LicenseSettings&module=Administration'>'\"许可证管理\"</a>  在管理员界面更新您的许可证信息，并恢复全部功能.",
    'FATAL_VALIDATION_EXPIRED'=> "严重: 您的许可证7天前已到期",
    'FATAL_VALIDATION_EXPIRED2'=> "请到 <a href='index.php?action=LicenseSettings&module=Administration'>'\"许可证管理\"</a>  在管理员界面更新您的许可证信息，并恢复全部功能.",
    'FATAL_VALIDATION_REQUIRED' => "严重: 您需要更新您的许可证信息 .<br>  请到 <a href='index.php?action=LicenseSettings&module=Administration'>'\"许可证管理\"</a>  在管理员界面更新您的许可证信息，并恢复全部功能.<br>要么重新保存您的许可证信息，使其被验证；要么先导出许可证，然后导入一个有效的许可证. " ,
    'HDR_LOGIN_PANEL'          => '请输入您的sugarcrm.com信任证书.',
    'HEARTBEAT_MESSAGE'=>"<BR>SuiteCRM更新机制允许您的服务器检查您当前的SuiteCRM更新是否可用。",

    'LBL_ACCEPT_TERMS' =>'接受团队和条件',
    'LBL_ACCEPT'                                => '接受',
    'LBL_ADMIN_SUGAR_SERVER'                => '管理员用户名:',
    'LBL_ADMIN_WIZARD_TITLE' => '管理员向导',
    'LBL_ADMIN_WIZARD' => '快速设置你的SuiteCRM系统',
