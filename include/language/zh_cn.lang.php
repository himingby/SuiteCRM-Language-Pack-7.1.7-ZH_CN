...
//       it is the key for the default case_relationship_type_dom value
  ...
  array (
    ...
    'Qualification' => '资格评估',
    'Needs Analysis' => '需求分析',
    'Value Proposition' => '方案讨论',
    'Id. Decision Makers' => '辨识决策者',
    'Perception Analysis' => '方案提交',
    'Proposal/Price Quote' => '投标报价',
    'Negotiation/Review' => '协商谈判',
    'Closed Won' => '成单',
    'Closed Lost' => '丢单',
  ),
  ...
  'reminder_time_options' => array( 60=> '提前1分钟',
                                  300=> '提前5分钟',
                                  600=> '提前10分钟',
                                  900=> '提前15分钟',
                                  1800=> '提前30分钟',
 ...
 'case_type_dom' =>
  ...
  array (
    ...
    'dom_switch_bool'       => array ('on' => '是',
                                        'off' => '否',
                                        '' => '否', ),
    'dom_email_link_type'   => array(   'sugar'     => 'Sugar邮件客户端',
                                        'mailto'    => '外部邮件客户端'),


    'dom_email_editor_option'=> array(  ''          => '系统默认邮件客户端',
                                        'html'      => 'HTML电子邮件',
                                        'plain'     => '纯文本电子邮件'),
...
$app_strings = array (
  ...
  'LBL_ICON_COLUMN_1' => '1列' /*for 508 compliance fix*/,
  ...
  'LBL_COMPANY_LOGO' => '公司ogo' /*for 508 compliance fix*/,
  'LBL_JS_CALENDAR' => '日历' /*for 508 compliance fix*/,
    ...
    'LBL_VIEWINLINE'=>'查看',
    'LBL_INFOINLINE'=>'信息',
    'LBL_POWERED_BY_SUGARCRM' => "技术支持SugarCRM",
    'LBL_PRINT' => "打印",
    'LBL_HELP' => "帮助",
    'LBL_ID_FF_SELECT' => "选择",
    'DEFAULT'                              => '基本',
    ...
    'LBL_ROUTING_ACTIONS_MARK_FLAGGED'      => '标记邮件',
    'LBL_ROUTING_ACTIONS_MARK_READ'         => '标记为已读',
    'LBL_ROUTING_ACTIONS_MARK_UNREAD'       => '标记为未读',
    'LBL_ROUTING_ACTIONS_MOVE_MAIL'         => '移动邮件',
    'LBL_ROUTING_ACTIONS_PEFORM'            => '执行接下来的动作',
    'LBL_ROUTING_ACTIONS_REPLY'             => '回复邮件',
    'LBL_ROUTING_CHECK_RULE'                => "发现一个错误:\n",
    ...
    'LBL_ROUTING_SUB_DESC'                  => '检查的规则是否有效. 点击名称来编辑.',
    'LBL_ROUTING_TO'                        => '到',
  ...
  'LBL_DROP_HERE' => '[拖放到这里]',
    ...
    'LBL_EMAIL_ACCOUNTS_OUTBOUND'           => '外部邮件服务器属性',
    'LBL_EMAIL_ACCOUNTS_SENDTYPE'           => '邮件转发代理',
    ...
    'LBL_EMAIL_WARNING_MISSING_USER_CREDS'  => '警告：没有外部电子邮件帐号的用户名和密码。',
    'LBL_EMAIL_ACCOUNTS_SMTPUSER_REQD'      => 'SMTP用户名是必填的',
    'LBL_EMAIL_ACCOUNTS_SMTPPASS_REQD'      => 'SMTP密码是必填的',
    'LBL_EMAIL_ACCOUNTS_TITLE'              => '邮件账户管理',
    'LBL_EMAIL_POP3_REMOVE_MESSAGE'     => '从下个版本开始，我们将不再支持POP3协议，只支持IMAP协议。',
  ...
  'LBL_EMAIL_ACCOUNTS_OUTBOUND_SUBTITLE'  => '提供SMTP服务器相关设置。',
    ...
    'LBL_EMAIL_ADDRESS_BOOK_ERR_NOT_CONTACT'=> '此次只能编辑联系人。',
    ...
    'LBL_EMAIL_ADDRESS_BOOK_NOT_FOUND'      => '没找到地址',
    ...
    'LBL_EMAIL_ADDRESS_PRIMARY'             => '电子邮件地址',
    ...
    'LBL_EMAIL_ATTACHMENTS'                 => '从本地',
    'LBL_EMAIL_ATTACHMENTS2'                => '从Sugar文档',
    ...
    'LBL_EMAIL_CHECKING_NEW'                => '检查新邮件',
    'LBL_EMAIL_CHECKING_DESC'               => '请稍等... <br><br>如果是第一次检查，会持续一段时间。',
    'LBL_EMAIL_CLOSE'                       => '关闭',
    'LBL_EMAIL_COFFEE_BREAK'                => '检查新邮件。 <br><br>大邮件帐户可能花费更多一些时间。',
    'LBL_EMAIL_COMMON'                      => '普通',

    'LBL_EMAIL_COMPOSE'                     => '撰写邮件',
    'LBL_EMAIL_COMPOSE_ERR_NO_RECIPIENTS'   => '请输入邮件接收人。',
    'LBL_EMAIL_COMPOSE_LINK_TO'             => '关联',
    'LBL_EMAIL_COMPOSE_NO_BODY'             => '邮件内容为空。确认要发送吗?',
    'LBL_EMAIL_COMPOSE_NO_SUBJECT'          => '这个邮件没有主题。确认要发送吗?',
    'LBL_EMAIL_COMPOSE_NO_SUBJECT_LITERAL'  => '(无主题)',
    'LBL_EMAIL_COMPOSE_READ'                => '阅读 & 撰写电子邮件',
    'LBL_EMAIL_COMPOSE_SEND_FROM'           => '从邮件帐户中发送',
    'LBL_EMAIL_COMPOSE_OPTIONS'             => '选项',
    'LBL_EMAIL_COMPOSE_INVALID_ADDRESS'     => '请在收件人、抄送、密送字段上填写有效的电子邮件地址。',

    'LBL_EMAIL_CONFIRM_CLOSE'               => '放弃这个邮件吗?',
    'LBL_EMAIL_CONFIRM_DELETE'              => '要从您的地址薄中移除这些吗?',
    ...
    'LBL_EMAIL_DATE_SENT_BY_SENDER'         => '发送时间',
  'LBL_EMAIL_DATE_RECEIVED'               => '接收时间',
    'LBL_EMAIL_ASSIGNED_TO_USER'            =>'负责用户',
    ...
    'LBL_EMAIL_ADDR_DISPLAY_MSG'            => '显示邮件地址 {0} - {1} 之 {2}',
    ...
    'LBL_EMAIL_ERROR_EMPTY'                 => '请输入一些查找条件。',
    'LBL_EMAIL_ERROR_GENERAL_TITLE'         => '一个错误已经发生',
    'LBL_EMAIL_ERROR_LIST_NAME'             => '此邮件列表已存在',
    ...
    'LBL_EMAIL_ERROR_NAME'                  => '名称需要填写。',
    'LBL_EMAIL_ERROR_FROM_ADDRESS'          => '发件人地址是需要填写的。请输入一个有效的电子邮件地址。',
    'LBL_EMAIL_ERROR_NO_FILE'               => '请提供一个文件。',
    'LBL_EMAIL_ERROR_NO_IMAP_FOLDER_RENAME' => '此次不能重命名IMAP文件夹。',
    'LBL_EMAIL_ERROR_SERVER'                => '邮件服务器地址是必填的。',
    'LBL_EMAIL_ERROR_SAVE_ACCOUNT'          => '邮件帐户可能未被保存。',
    'LBL_EMAIL_ERROR_TIMEOUT'               => '在与邮件服务器连接时发生错误。',
    'LBL_EMAIL_ERROR_USER'                  => '登录名是必填的。',
    'LBL_EMAIL_ERROR_PASSWORD'              => '密码是必填的。',
    'LBL_EMAIL_ERROR_PORT'                  => '邮件服务器端口号是必填的。',
    'LBL_EMAIL_ERROR_PROTOCOL'              => '服务器协议是必填的。',
    'LBL_EMAIL_ERROR_MONITORED_FOLDER'      => '监控文件夹是必填的。',
    'LBL_EMAIL_ERROR_TRASH_FOLDER'          => '垃圾文件夹是必填的。',
    'LBL_EMAIL_ERROR_VIEW_RAW_SOURCE'       => '该信息是无效的。',
    'LBL_EMAIL_ERROR_NO_OUTBOUND'           => '没有指定发送邮件服务器',
    ...
    'LBL_EMAIL_FOLDERS_ACTIONS'             => '移动至',
    'LBL_EMAIL_FOLDERS_ADD'                 => '增加',
    'LBL_EMAIL_FOLDERS_ADD_DIALOG_TITLE'    => '增加新文件夹',
    ...
    'LBL_EMAIL_FOLDERS_NEW_FOLDER'          => '新建文件夹名称',
    'LBL_EMAIL_FOLDERS_NO_VALID_NODE'       => '在执行这个动作前请选择一个文件夹。',
    ...
    'LBL_EMAIL_MARK'                        => '标记',
    'LBL_EMAIL_MARK_FLAGGED'                => '为已标记',
    'LBL_EMAIL_MARK_READ'                   => '为已读',
    'LBL_EMAIL_MARK_UNFLAGGED'              => '为未标记',
    'LBL_EMAIL_MARK_UNREAD'                 => '为未读',
    ...
    'LBL_EMAIL_MENU_MAKE_SELECTION'         => '请在尝试此操作进行选择。',

    'LBL_EMAIL_MENU_HELP_ADD_FOLDER'        => '创建一个文件夹 (远程或在Sugar中)',
    'LBL_EMAIL_MENU_HELP_ARCHIVE'           => '归档这些邮件',
    'LBL_EMAIL_MENU_HELP_COMPOSE_TO_LIST'   => '给选择的邮件列表发邮件',
    'LBL_EMAIL_MENU_HELP_CONTACT_COMPOSE'   => '给这个联系人发邮件',
    ...
    'LBL_EMAIL_MENU_HELP_EMPTY_TRASH'       => '为您的邮件账户清空所有的垃圾箱',
    'LBL_EMAIL_MENU_HELP_MARK_FLAGGED'      => '标记这些邮件为已标记',
    'LBL_EMAIL_MENU_HELP_MARK_READ'         => '标记这些邮件为已读',
    'LBL_EMAIL_MENU_HELP_MARK_UNFLAGGED'    => '标记这些邮件为未标记',
    'LBL_EMAIL_MENU_HELP_MARK_UNREAD'       => '标记这写邮件为未读',
    ...
    'LBL_EMAIL_MENU_HELP_REPLY_ALL'         => '回复给所有这些邮件的接受人',
    ...
    'LBL_EMAIL_RETRIEVING_LIST'             => '检索邮件列表',
    'LBL_EMAIL_RETRIEVING_MESSAGE'          => '检索消息',
    'LBL_EMAIL_RETRIEVING_RECORD'           => '检索电子邮件记录',
    ...
    'LBL_EMAIL_SEARCH_FULL_TEXT'            => '正文',
    'LBL_EMAIL_SEARCH_NO_RESULTS'           => '根据您的查询条件没有找到记录。',
    ...
    'LBL_EMAIL_SETTINGS_TO_EMAIL_ADDR'      => '收件人地址',
    'LBL_EMAIL_SETTINGS_FROM_NAME'          => '发件人名称',
    'LBL_EMAIL_SETTINGS_REPLY_TO_ADDR'      =>'回复地址',
    'LBL_EMAIL_SETTINGS_FULL_SCREEN'        => '全屏',
    ...
    'LBL_EMAIL_SETTINGS_RETRIEVING_GROUP'   => '检索组文件夹',

    'LBL_EMAIL_SETTINGS_GROUP_FOLDERS_EDIT' => '编辑组文件夹',

    'LBL_EMAIL_SETTINGS_NAME'               => '电子邮件账户名',
    'LBL_EMAIL_SETTINGS_REQUIRE_REFRESH'    => '在“收件箱”中选择每页显示的邮件数量。此设置可能需要刷新页面才能生效。',
    'LBL_EMAIL_SETTINGS_RETRIEVING_ACCOUNT' => '检索邮件帐户',
    'LBL_EMAIL_SETTINGS_RULES'              => '规则',
    'LBL_EMAIL_SETTINGS_SAVED'              => '设置已经保存。\n\n您必须刷新页面使新设置有效。',
    'LBL_EMAIL_SETTINGS_SEND_EMAIL_AS'      => '只发送纯文本邮件',
  ...
  'LBL_SMTPTYPE_EXCHANGE'                 => 'Microsoft Exchange',
    ...
    'LBL_EMAIL_VIEW_PRINTABLE'              => '打印版本',
    'LBL_EMAIL_VIEW_RAW'                    => '显示原始邮件',
    'LBL_EMAIL_VIEW_UNSUPPORTED'            => '当使用POP3协议时，不支持这项功能。',
    'LBL_DEFAULT_LINK_TEXT'                 => '默认的链接文本。',
    'LBL_EMAIL_YES'                         => '是的',
    ...
    'LBL_EMAIL_IMPORT_FAIL'                 => '导入失败，该消息已经被导入或已从服务器删除',
    ...
    'ERR_SELF_REPORTING' => '用户的上级领导不能是自己。',
    ...
    'ERR_EXISTING_PORTAL_USERNAME'=>'错误: 门户名称已经分配给另外的联系人。',
    'ERR_COMPATIBLE_PRECISION_VALUE' => '数值与精度不匹配',
    'ERR_EXTERNAL_API_SAVE_FAIL' => '保存外部帐号时出错',
    'ERR_EXTERNAL_API_UPLOAD_FAIL' => '上传出错。请确认您上传的不是空的文件。',
    'ERR_NO_DB' => '无法连接上数据库。详情请查看sugarcrm.log。',
    'ERR_DB_FAIL' => '数据库错误。详情请查看sugarcrm.log。',
    'ERR_EXTERNAL_API_403' => '权限被拒绝。文件类型不支持。',
    'ERR_EXTERNAL_API_NO_OAUTH_TOKEN' => 'OAuth访问令牌丢失。',
    'ERR_DB_VERSION' => 'Sugar CRM {0} 的文件有可能被Sugar CRM {1} 数据库使用了。',
    'LBL_ACCOUNT'=>'客户',
    ...
    'LBL_CLOSEALL_BUTTON_TITLE' => '全部关闭[Alt+Q]',
    'LBL_CLOSE_AND_CREATE_BUTTON_LABEL' => '关闭并创建',
    'LBL_CLOSE_AND_CREATE_BUTTON_TITLE' => '关闭并创建[Alt+C]',
    ...
    'LBL_EMPTY_REQUIRED_VCARD' => 'vCard没有这个模块所需要的字段。详情请查看sugarcrm.log日志文件。',
    'LBL_VCARD_ERROR_FILESIZE' => '上传的文件太大，超过了设定的30000字节。',
    'LBL_VCARD_ERROR_DEFAULT' => '上传vCard文件出错。详情请查看sugarcrm.log日志文件。',
    ...
    'LBL_FIXED_IN_RELEASE'=>'在发布版本中已解决',
    ...
    'LBL_LISTVIEW_LESS_THAN_TEN_SELECT' => '请选择少于10条记录进行操作。',
    'LBL_LISTVIEW_ALL' => '全部',
    'LBL_LISTVIEW_NONE' => '不选择全部',
    'LBL_LISTVIEW_OPTION_CURRENT' => '选择本页',
    ...
    'LBL_OPT_OUT_FLAG_PRIMARY' => '不共享主邮件',
    'LBL_MEETINGS'=>'会议',
    'LBL_MEETING'=>'会议',
    ...
    'LBL_OPENALL_BUTTON_LABEL' => '全部打开',
    'LBL_OPENALL_BUTTON_TITLE' => '全部打开[Alt+O]',
    'LBL_OPENTO_BUTTON_KEY' => 'T',
    'LBL_OPENTO_BUTTON_LABEL' => '打开到: ',
    'LBL_OPENTO_BUTTON_TITLE' => '打开到[Alt+T]:',
    ...
    'LBL_SEE_ALL' => 'See All',
    'LBL_UPLOAD_IMAGE_FILE_INVALID' => '无效的文件格式，仅图片可以上传。',
    'LBL_SELECT_BUTTON_KEY' => 'T',
    'LBL_SELECT_BUTTON_LABEL' => '选择',
    'LBL_SELECT_BUTTON_TITLE' => '选择[Alt+T]',
    'LBL_SELECT_TEAMS_KEY' => 'Z',
    'LBL_SELECT_TEAMS_LABEL' => '新增团队',
    'LBL_SELECT_TEAMS_TITLE' => '新增团队[Alt+Z]',
    ...
    'LBL_ACCESSKEY_SELECT_FILE_LABEL' => '选择文件[Alt+F]',
    ...
    'LBL_ACCESSKEY_SELECT_ACCOUNTS_LABEL' => '选择客户[Alt+A]',
    ...
    'LBL_ACCESSKEY_SELECT_CAMPAIGNS_LABEL' => '选择市场活动[Alt+M]',
    ...
    'LBL_ACCESSKEY_SELECT_CONTACTS_LABEL' => '选择联系人[Alt+C]',
    ...
    'LBL_ACCESSKEY_SELECT_TEAMSET_LABEL' => '选择团队[Alt+Z]',
    ...
    'LBL_SUGAR_COPYRIGHT' => '&copy; 2004-2013 SugarCRM公司开发的此程序，不提供服务。这符合 <a href="LICENSE.txt" target="_blank" class="copyRightLink">AGPLv3</a>通用公共授权的许可.<br />SugarCRM是SugarCRM公司的注册商标。 所有其他公司和产品名称有可能是其各自公司的注册商标。',



    // The following version of LBL_SUGAR_COPYRIGHT is for Professional and Enterprise editions.

    'LBL_SUGAR_COPYRIGHT_SUB' => '&copy; 2004-2013 <a href="http://www.suitecrm.com" target="_blank" class="copyRightLink">SuiteCRM公司.</a> 版权所有.<br />SugarCRM是SugarCRM公司的注册商标。 所有其他公司和产品名称有可能是其各自公司的注册商标。',


    'LBL_SYNC' => '同步',
    'LBL_SYNC' => '同步',
    'LBL_TABGROUP_ALL' => 'All全部',
    'LBL_TABGROUP_ACTIVITIES' => 'A活动',
    'LBL_TABGROUP_COLLABORATION' => 'C协作',
    'LBL_TABGROUP_HOME' => 'Dashboard',
    'LBL_TABGROUP_MARKETING' => 'M市场营销',
    'LBL_TABGROUP_MY_PORTALS' => '我的网站',
    'LBL_TABGROUP_OTHER' => '其他',
    'LBL_TABGROUP_REPORTS' => '报表',
    'LBL_TABGROUP_SALES' => 'S销售',
    'LBL_TABGROUP_SUPPORT' => 'P服务',
    ...
    'NTC_CLICK_BACK' => '请按浏览器的“返回”按钮返回，并修复该错误。',
    ...
    'NTC_DELETE_SELECTED_RECORDS' =>' 已选择的记录?',
    'NTC_LOGIN_MESSAGE' => '请输入用户名和密码。',
    'NTC_NO_ITEMS_DISPLAY' => '无',
    'NTC_REMOVE_CONFIRMATION' => '您确定要移除这个关系吗? 只有该关系被移除。不会删除记录。',
    'NTC_REQUIRED' => '表示必填字段',
    'NTC_SUPPORT_SUGARCRM' => '要支持SugarCRM开源项目，可以通过paypal捐款。-paypal快速、免费还安全！',
    'NTC_TIME_FORMAT' => '(24:00)',
    'NTC_WELCOME' => '欢迎',
    'NTC_YEAR_FORMAT' => '(yyyy)',
    'LOGIN_LOGO_ERROR'=> '请更换SugarCRM的logo。',
    'ERROR_LICENSE_FULLY_EXPIRED'=> "贵公司的订阅的SugarCRM的产品已经过期，需要更新。当订阅已过期后，只有管理员可以登录。如果您有任何问题，请联系您的系统管理员。",
    'ERROR_LICENSE_EXPIRED'=> "贵公司使用的SugarCRM的许可需要被更新,只有管理员可以登陆",
    'ERROR_LICENSE_VALIDATION'=> "贵公司使用的SugarCRM的许可需要被更新,只有管理员可以登陆",
    'WARN_BROWSER_VERSION_WARNING' => "<b>警告:</b> 不支持您的浏览器或版本.<p></p>推荐使用下列浏览器:<p></p><ul><li>IE10 (不支持兼容模式)<li>Firefox 32.0<li>Safari 5.1<li>Chrome 37</ul>",
    'WARN_BROWSER_IE_COMPATIBILITY_MODE_WARNING' => "<b>警告:</b> 您的浏览器是IE兼容模式，不支持IE兼容模式。",
    'WARN_LICENSE_SEATS'=>  "警告：活动的用户数量已经达到许可证允许的最大用户数。",
    'WARN_LICENSE_SEATS_MAXED'=>  "警告：活动的用户数量已经超过许可证允许的最大用户数。",
    'WARN_ONLY_ADMINS'=> "只有管理员才能登陆。",
    'WARN_UNSAVED_CHANGES'=> "当前记录已修改，离开当前界面，修改数据将丢失。您确定要离开当前界面吗？",
    'ERROR_NO_RECORD' => '检索记录出错。该记录已经被删除或者您无权查看此记录。',
    'ERROR_TYPE_NOT_VALID' => '出错。此类型无效。',
    'ERROR_NO_BEAN' => '无法获取bean.', 
    ...
    'MSG_JS_ALERT_MTG_REMINDER_RELATED_TO' => '相关: ',
    'MSG_JS_ALERT_MTG_REMINDER_CALL_MSG' => "\n点击’确定‘来查看此电话或点击“取消”忽略此消息。",
  	'MSG_JS_ALERT_MTG_REMINDER_MEETING_MSG' => "\n点击’确定‘来查看此会议或点击“取消”忽略此消息。",
 	'MSG_LIST_VIEW_NO_RESULTS_BASIC' => "没有找到结果。",
	'MSG_LIST_VIEW_NO_RESULTS' => "没有找到<item1>的结果。",
  ...
  'ERR_MSSQL_WARNING' =>'警告:',
    ...
    //Meta-Data framework
    'ERR_MISSING_VARDEF_NAME' => '警告: 字段 [[field]] 在 [moduleDir] vardefs.php文件中不能有一个映射条目',
    'ERR_CANNOT_CREATE_METADATA_FILE' => '错误: 文件 [[file]] 丢失。没有找到对应的HTML文件所以无法创建。',
  'ERR_CANNOT_FIND_MODULE' => '错误: 模块 [module] 不存在.',
  'LBL_ALT_ADDRESS' => '其他地址:',
    'ERR_SMARTY_UNEQUAL_RELATED_FIELD_PARAMETERS' => '错误: 在displayParams数组中，参数 \'key\' 和 \'copy\' 数量不相等。',
    'ERR_SMARTY_MISSING_DISPLAY_PARAMS' => '在displayParams数组中丢失了索引: ',

    /* MySugar Framework (for Home and Dashboard) */
    'LBL_DASHLET_CONFIGURE_GENERAL' => '整体',
    'LBL_DASHLET_CONFIGURE_FILTERS' => '过滤器',
    'LBL_DASHLET_CONFIGURE_MY_ITEMS_ONLY' => '仅显示我的项目',
    ...
    'LBL_MAX_DASHLETS_REACHED' => '已经达到管理员设置的最大数量的新增栏. 如果要增加新的新增栏请先移除.',
    ...
    'LBL_SEARCH_TOOLS' => '工具',
    'LBL_SEARCH_HELP_TITLE' => '搜索提示',
    'LBL_SEARCH_HELP_CLOSE_TOOLTIP' => '关闭',
    'LBL_SEARCH_RESULTS_FOUND' => '找到搜索结果',
  ...
  'MSG_OR_GREATER' => '或者大于',
    ...
    'LBL_PORTAL_WELCOME_TITLE' => '欢迎使用Sugar Portal 5.1.0',
    ...
    'LBL_CHOOSE_START_AND_END_DATES' => '请选择一个开始和结束日期范围',
    'LBL_CHOOSE_START_AND_END_ENTRIES' => '请选择起始和结束范围条目',
  ...
  'ERROR_UNABLE_TO_RETRIEVE_DATA' => '错误: 不能为 {0} 连接器获取数据.  该服务不可用或者配置设置无效。 连接器错误信息: ({1}).',
  'LBL_MERGE_CONNECTORS' => '获取数据',
  'LBL_MERGE_CONNECTORS_BUTTON_KEY' => '[D]',
  'LBL_REMOVE_MODULE_ENTRY' => '您确定要对这个模块停用连接器吗?',

    // fastcgi checks
    'LBL_FASTCGI_LOGGING'      => '为获的使用IIS/FastCGI sapi的最佳体验，在php.ini文件设置fastcgi.logging为0。',

    //cma
    'LBL_MASSUPDATE_DELETE_GLOBAL_TEAM'=> '您不能删除全局团队。',
    'LBL_MASSUPDATE_DELETE_USER_EXISTS'=>'您不能删除该私有团队 [{0}] ，除非先删除用户 [{1}]。',

    //martin #25548
    'LBL_NO_FLASH_PLAYER' => '您没有安装或者正在使用一款旧的Adobe Flash Player.  <a href="http://www.adobe.com/go/getflashplayer/">点击这里</a>获取最新版的Flash Player。',
  //Collection Field
  ...
  'LBL_NEXT_YEAR'=> '明年',
    ...
    'LBL_INVALID_USA_PHONE_FORMAT' => '请输入一个美国电话号码，包括区号。',
  ...
  'ERR_FILE_NOT_FOUND' => '错误: 无法加载文件 {0}.  请检查服务器配置.',
    ...
    'ERR_RSS_INVALID_INPUT' => 'RSS不是一个有效的input_type。',
    'ERR_RSS_INVALID_RESPONSE' => '针对这种方法，RSS不是一个有效的response_type。',

    //External API Error Messages
    'ERR_GOOGLE_API_415' => 'Google文档不支持您提供的文件格式。',
...
"这是一个导入模板文件，包含了要导入CRM的示例内容。"
"这是一个CSV文件，用逗号分开字段，使用双引号作为字段限定符。"

"标题行是文件的最上面的行，包含了字段标签，这个标签和你在应用程序中看到的一样。"
"这些标签用来与应用程序中的字段做映射。"

"注意: 数据库里的字段名称也可以使用在标题行中。这在您使用phpMyAdmin或其他数据库工具导出的数据作为导入的时候尤其有用。"
"在导入过程中字段的正确匹配是关键所在，字段的顺序并不重要。"
...
"5. 在应用程序的操作菜单下电极导入按钮，并上传保存的文件"
   ',
    ...
    'MSG_SHOW_DUPLICATES' => '将要创建的记录 {0} ，可能跟已有记录 {0} 重复。记录 {1} 含有相同的名字，如下所示。  点击保存将创建一个新的 {0}, 或者点击取消不创建新纪录 {0}返回模块.',
    'LBL_EMAIL_TITLE' => '电子邮件地址',
    'LBL_EMAIL_OPT_TITLE' => '不共享电子邮件地址',
    'LBL_EMAIL_INV_TITLE' => '无效电子邮件地址',
    'LBL_EMAIL_PRIM_TITLE' => '主要电子邮件地址',
    'LBL_SELECT_ALL_TITLE' => '全选',
    'LBL_SELECT_THIS_ROW_TITLE' => '选择该行',
    'LBL_TEAM_SELECTED_TITLE' => '已选择团队 ',
    'LBL_TEAM_SELECT_AS_PRIM_TITLE' => '选中主团队',

    //for upload errors
    'UPLOAD_ERROR_TEXT'          => '错误: 上传中出错。 错误码: {0} - {1}',
    'UPLOAD_ERROR_TEXT_SIZEINFO' => '错误: 上传中出错。 错误码: {0} - {1}. 上传最大值是 {2} ',
    'UPLOAD_ERROR_HOME_TEXT'     => '错误: 上传中出错, 请联系系统管理员。',
    'UPLOAD_MAXIMUM_EXCEEDED'    => '要上传文件的大小 ({0} bytes) 超过了最大限制: {1} bytes',
    'UPLOAD_REQUEST_ERROR'    => '出错，请刷新页面并重试。',
    //508 used Access Keys
    'LBL_EDIT_BUTTON_KEY' => 'i',
    'LBL_EDIT_BUTTON_LABEL' => '编辑',
    'LBL_EDIT_BUTTON_TITLE' => '编辑[Alt+i]',
    ...
    'LBL_SAVE_BUTTON_TITLE' => '保存[Alt+a]',
    'LBL_CANCEL_BUTTON_KEY' => 'l',
    'LBL_CANCEL_BUTTON_LABEL' => '取消',
    'LBL_CANCEL_BUTTON_TITLE' => '取消[Alt+l]',
    'LBL_FIRST_INPUT_EDIT_VIEW_KEY' => '7',
    'LBL_ADV_SEARCH_LNK_KEY' => '8',
    'LBL_FIRST_INPUT_SEARCH_KEY' => '9',
    'LBL_GLOBAL_SEARCH_LNK_KEY' => '0',
    'LBL_KEYBOARD_SHORTCUTS_HELP_TITLE' => '键盘快捷键',
    'LBL_KEYBOARD_SHORTCUTS_HELP' => '<p><strong>表单功能 - Alt+</strong><br/> I = 编辑<b>I</b> (详细视图)<br/> U = 复制<b>U</b> (详细视图)<br/> D = <b>D</b>删除 (详细视图)<br/> A = 保存<b>A</b> (编辑视图)<br/> L = 取消<b>L</b> (编辑视图) <br/><br/></p><p><strong>搜索和导航  - Alt+</strong><br/> 7 = 编辑表单上的第一个字段<br/> 8 = 高级搜索链接<br/> 9 = 搜索表单上的第一个字段<br/> 0 = 全局搜索<br></p>' ,
    'ERR_CONNECTOR_NOT_ARRAY' => '连接器中的 {0} 配置不正确，无法使用。',
    'ERR_SUHOSIN' => '上传流被Suhosin拦截, 请添加&quot;上传&quot; to suhosin.executor.include.whitelist (详情请查看sugarcrm.log)',
...
$app_list_strings['kbdocument_status_dom'] = array (
   ...
   $app_list_strings['kbadmin_actions_dom'] =
    ...
    'Delete Tag'=>'删除标签',
    'Rename Tag'=>'重命名标签',
    'Move Selected Articles'=>'移动所选文章',
    'Apply Tags On Articles'=>'为文章应用标签',
    'Delete Selected Articles'=>'删除所选文章',
  );
  ...
  $app_list_strings['moduleList']['Sugar_Favorites'] = '收藏';
